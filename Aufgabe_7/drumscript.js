...
window.addEventListener("load", function () {
    ...
    var TonA = new Audio("assets/A.mp3");
    var TonC = new Audio("assets/C.mp3");
    var TonF = new Audio("assets/F.mp3");
    var TonG = new Audio("assets/G.mp3");
    var laugh1 = new Audio("assets/laugh-1.mp3");
    var laugh2 = new Audio("assets/laugh-2.mp3");
    var simplebeat = [kick, hihat, snare];
